...
HD_PWD='/home/oem/xauiexmaple/xauiexmaple.runs/xaui_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xaui_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xaui_0.tcl
